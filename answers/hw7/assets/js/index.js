	...
	*/
	...
	const SWITCHLANG = (function() {
		...
		function changeLang(e) {
			...
			if (getAttr === "en") {
				document.getElementById("mainTitle").innerHTML = window.I18N["en"].TITLE;
				m_lang = "en";
				...
				LIZONE.innerHTML="";
				init();
			} else if (getAttr === "zh-tw") {
				document.getElementById("mainTitle").innerHTML = window.I18N["zh-tw"].TITLE;
				m_lang = "zh-tw";
				//the following 4 lines: recalculation
				m_offset = 0;
				m_dataOffset = 0;
